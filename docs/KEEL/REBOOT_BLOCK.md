...
5. Report any drift (commit SHA, test count, dirty files) before editing anything.
...
- Checkpoint: Run bash tools/keel-checkpoint.sh every 30 minutes or after major tasks.
